...
bracelet_colors = {
    "Student1": "#FF0000",   # Red
    "Student2": "#808080",   # Gray
    "Student3": "#75FF33",   # Green
    "Student4": "#F3FF33",   # Yellow
    "Student5": "#D633FF",   # Purple
    "Student6": "#FF33A8",   # Pink
    "Student7": "#33FFD7",   # Aqua
    "Student8": "#FF9E33",
    "Student9": "#C70039", 
    "Student10": "#900C3F", 
    "Student11": "#581845", 
...
def save_registration():
    ...
    existing = collection.find_one({"bracelet_id": selected_bracelet_id})
    if existing:
        messagebox.showerror("Already Exists", f"{selected_bracelet_id} is already registered to {existing['student_name']}")
    else:
...
def scan_name_easyocr():
    ...
    if results:
        ...
        student_name_var.set(student_name)
    else:
